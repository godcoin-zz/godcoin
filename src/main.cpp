...
uint256 hashGenesisBlock("0xd0fefe24d89c62430a7b470cf5087c1bb57605b6b3c6068af5784b8e7e8caee3");
...
const string strMessageMagic = "GodCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // GodCoin: 1 days
static const int64 nTargetSpacing = 60; // GodCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal godcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GodCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1387624916; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 144855;

        if (fTestNet)
        {
            block.nTime    = 1387115134;
            block.nNonce   = 68049;
        }
